...
}, '1.0pr' ,{requires:['collection','aui-base']});
...
}, '1.0pr' ,{requires:['aui-base','anim','anim-node-plugin']});


AUI.add('aui-node', function(A){}, '1.0pr' ,{use:['aui-node-base','aui-node-html5','aui-node-fx'], skinnable:false});
