...
}, '1.0pr' ,{requires:['aui-overlay-context','datatype-date','widget-locale'], skinnable:true});
...
}, '1.0pr' ,{requires:['aui-calendar-base','aui-button'], skinnable:true});


AUI.add('aui-calendar', function(A){}, '1.0pr' ,{skinnable:true, use:['aui-calendar-base','aui-calendar-datepicker-select']});
