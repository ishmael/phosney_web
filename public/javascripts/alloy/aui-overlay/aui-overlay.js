 ...
 */
A.OverlayBase = A.Base.build('overlay', A.Component, [A.WidgetPosition, A.WidgetStack, A.WidgetPositionAlign, A.WidgetStdMod]);

}, '1.0pr' ,{requires:['aui-component','widget-position','widget-stack','widget-position-align','widget-stdmod']});
 ...
 */
function OverlayContext(config) {
	var instance = this;
...
A.extend(OverlayContext, A.OverlayBase, {
	/**
...
}, '1.0pr' ,{requires:['aui-overlay-manager','aui-delayed-task']});
 ...
 */
function OverlayContextPanel(config) {
 	OverlayContextPanel.superclass.constructor.apply(this, arguments);
}

A.mix(OverlayContextPanel, {
	/**
	 * Static property provides a string to identify the class.
	 *
...
A.extend(OverlayContextPanel, A.OverlayContext, {
	/**
...
}, '1.0pr' ,{requires:['aui-overlay-context','anim'], skinnable:true});
...
}, '1.0pr' ,{requires:['aui-base','aui-overlay-base','overlay','plugin']});
...
A.extend(OverlayMask, A.OverlayBase, {
	/**
...
}, '1.0pr' ,{requires:['aui-base','aui-overlay-base','event-resize'], skinnable:true});


AUI.add('aui-overlay', function(A){}, '1.0pr' ,{skinnable:true, use:['aui-overlay-base','aui-overlay-context','aui-overlay-context-panel','aui-overlay-manager','aui-overlay-mask']});
