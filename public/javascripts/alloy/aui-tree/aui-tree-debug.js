...
}, '1.0pr' ,{requires:['aui-tree-data','io','json'], skinnable:false});
...
}, '1.0pr' ,{requires:['aui-tree-node','dd'], skinnable:true});


AUI.add('aui-tree', function(A){}, '1.0pr' ,{skinnable:true, use:['aui-tree-data', 'aui-tree-node', 'aui-tree-view']});
