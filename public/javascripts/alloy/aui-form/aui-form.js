...
}, '1.0pr' ,{requires:['aui-base','aui-data-set','aui-form-field','querystring-parse']});
...
}, '1.0pr' ,{requires:['aui-form-textarea','aui-toolbar'], skinnable:true});
...
}, '1.0pr' ,{requires:['aui-base','aui-component','substitute']});
...
}, '1.0pr' ,{requires:['aui-base','substitute']});
...
}, '1.0pr' ,{requires:['aui-form-textfield'], skinnable:true});
...
AUI.add('aui-form', function(A){}, '1.0pr' ,{skinnable:false, use:['aui-form-base','aui-form-combobox','aui-form-field','aui-form-manager','aui-form-textarea','aui-form-textfield']});
