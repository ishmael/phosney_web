...
}, '1.0pr' ,{requires:['anim','aui-overlay-mask','substitute'], skinnable:true});
...
}, '1.0pr' ,{requires:['aui-image-viewer-base','aui-paginator','aui-toolbar'], skinnable:true});


AUI.add('aui-image-viewer', function(A){}, '1.0pr' ,{skinnable:true, use:['aui-image-viewer-base','aui-image-viewer-gallery']});
